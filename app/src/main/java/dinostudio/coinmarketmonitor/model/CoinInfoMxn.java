...
public class CoinInfoMxn extends RealmObject {
    ...
    public String getDayVolumeMxn() {
        return dayVolumeMxn;
    }

    public void setDayVolumeMxn(String dayVolumeMxn) {
        this.dayVolumeMxn = dayVolumeMxn;
    }
