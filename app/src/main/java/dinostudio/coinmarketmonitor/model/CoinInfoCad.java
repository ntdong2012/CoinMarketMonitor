...
public class CoinInfoCad extends RealmObject {
    ...
    public String getDayVolumeCad() {
        return dayVolumeCad;
    }

    public void setDayVolumeCad(String dayVolumeCad) {
        this.dayVolumeCad = dayVolumeCad;
    }
