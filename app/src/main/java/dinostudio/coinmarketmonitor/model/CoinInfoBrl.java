...
public class CoinInfoBrl extends RealmObject {
    ...
    public String getDayVolumeBrl() {
        return dayVolumeBrl;
    }

    public void setDayVolumeBrl(String dayVolumeBrl) {
        this.dayVolumeBrl = dayVolumeBrl;
    }
