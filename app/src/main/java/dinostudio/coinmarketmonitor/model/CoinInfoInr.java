...
public class CoinInfoInr extends RealmObject{
    ...
    public String getDayVolumeInr() {
        return dayVolumeInr;
    }

    public void setDayVolumeInr(String dayVolumeInr) {
        this.dayVolumeInr = dayVolumeInr;
    }
