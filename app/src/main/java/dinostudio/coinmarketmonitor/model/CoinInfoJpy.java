...
public class CoinInfoJpy extends RealmObject {
    ...
    public String getDayVolumeJpy() {
        return dayVolumeJpy;
    }

    public void setDayVolumeJpy(String dayVolumeJpy) {
        this.dayVolumeJpy = dayVolumeJpy;
    }
