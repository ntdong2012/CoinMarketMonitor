...
public class CoinInfoKrw extends RealmObject {
    ...
    public String getDayVolumeKrw() {
        return dayVolumeKrw;
    }

    public void setDayVolumeKrw(String dayVolumeKrw) {
        this.dayVolumeKrw = dayVolumeKrw;
    }
