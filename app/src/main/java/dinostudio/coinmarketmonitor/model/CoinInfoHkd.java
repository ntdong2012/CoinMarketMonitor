...
public class CoinInfoHkd extends RealmObject {
    ...
    public String getDayVolumeHkd() {
        return dayVolumeHkd;
    }

    public void setDayVolumeHkd(String dayVolumeHkd) {
        this.dayVolumeHkd = dayVolumeHkd;
    }
