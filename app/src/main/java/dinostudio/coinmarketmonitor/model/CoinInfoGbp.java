...
public class CoinInfoGbp extends RealmObject {
    ...
    private String dayVolumeGbp;
    @SerializedName("market_cap_gbp")
    ...
    public String getDayVolumeGbp() {
        return dayVolumeGbp;
    }

    public void setDayVolumeGbp(String dayVolumeGbp) {
        this.dayVolumeGbp = dayVolumeGbp;
    }

    public String getMarketCapGbp() {
        return marketCapGbp;
    }

    public void setMarketCapGbp(String marketCapGbp) {
